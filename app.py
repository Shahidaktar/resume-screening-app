...
def pred():
    if 'resume' in request.files:
        ...
        return render_template('index.html',recommended_job=recommended_job,name=name,phone=phone,email=email,skills=extracted_skills,education_list=extracted_education)
    else:
